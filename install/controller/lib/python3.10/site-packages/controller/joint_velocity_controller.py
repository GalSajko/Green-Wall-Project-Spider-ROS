...
class JointVelocityController(Node):
    ...
    def move_spider_callback(self, request, response):
        ...
        self.get_logger().info(f"{len(time_vector)}")
        self.get_logger().info(f"{currents_data.shape}")
        self.get_logger().info(f"{time_vector}")
        self.get_logger().info(f"{currents_data}")
