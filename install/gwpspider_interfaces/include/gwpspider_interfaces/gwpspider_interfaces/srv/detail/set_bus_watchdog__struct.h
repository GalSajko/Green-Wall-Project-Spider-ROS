...
#ifndef GWPSPIDER_INTERFACES__SRV__DETAIL__SET_BUS_WATCHDOG__STRUCT_H_
#define GWPSPIDER_INTERFACES__SRV__DETAIL__SET_BUS_WATCHDOG__STRUCT_H_
...
typedef struct gwpspider_interfaces__srv__SetBusWatchdog_Request__Sequence
{
...
/// Struct defined in srv/SetBusWatchdog in the package gwpspider_interfaces.
typedef struct gwpspider_interfaces__srv__SetBusWatchdog_Response
{
  bool success;
} gwpspider_interfaces__srv__SetBusWatchdog_Response;

// Struct for a sequence of gwpspider_interfaces__srv__SetBusWatchdog_Response.
typedef struct gwpspider_interfaces__srv__SetBusWatchdog_Response__Sequence
{
...
#endif  // GWPSPIDER_INTERFACES__SRV__DETAIL__SET_BUS_WATCHDOG__STRUCT_H_
