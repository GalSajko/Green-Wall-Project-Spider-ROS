...
#include "gwpspider_interfaces/msg/detail/water_pump_command__rosidl_typesupport_fastrtps_c.h"
...
using _WaterPumpCommand__ros_msg_type = gwpspider_interfaces__msg__WaterPumpCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WaterPumpCommand__ros_msg_type * ros_message = static_cast<const _WaterPumpCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: pump
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WaterPumpCommand__ros_msg_type * ros_message = static_cast<_WaterPumpCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: pump
  {
    cdr >> ros_message->pump;
  }
...
static uint32_t _WaterPumpCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gwpspider_interfaces__msg__WaterPumpCommand(
...
static size_t _WaterPumpCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gwpspider_interfaces__msg__WaterPumpCommand(
...
static message_type_support_callbacks_t __callbacks_WaterPumpCommand = {
...
static rosidl_message_type_support_t _WaterPumpCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WaterPumpCommand,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, msg, WaterPumpCommand)() {
  return &_WaterPumpCommand__type_support;
}
