...
#include "gwpspider_interfaces/msg/detail/gripper_command__rosidl_typesupport_fastrtps_c.h"
...
using _GripperCommand__ros_msg_type = gwpspider_interfaces__msg__GripperCommand;
...
static uint32_t _GripperCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gwpspider_interfaces__msg__GripperCommand(
...
static size_t _GripperCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gwpspider_interfaces__msg__GripperCommand(
