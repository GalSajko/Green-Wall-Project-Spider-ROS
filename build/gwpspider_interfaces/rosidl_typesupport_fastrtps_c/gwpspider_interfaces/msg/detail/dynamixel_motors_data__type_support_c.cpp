...
#include "gwpspider_interfaces/msg/detail/dynamixel_motors_data__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float32_multi_array__functions.h"  // currents, motor_errors, positions, temperatures
...
using _DynamixelMotorsData__ros_msg_type = gwpspider_interfaces__msg__DynamixelMotorsData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DynamixelMotorsData__ros_msg_type * ros_message = static_cast<const _DynamixelMotorsData__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _DynamixelMotorsData__ros_msg_type * ros_message = static_cast<_DynamixelMotorsData__ros_msg_type *>(untyped_ros_message);
  // Field name: positions
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_gwpspider_interfaces__msg__DynamixelMotorsData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DynamixelMotorsData__ros_msg_type * ros_message = static_cast<const _DynamixelMotorsData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DynamixelMotorsData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gwpspider_interfaces__msg__DynamixelMotorsData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gwpspider_interfaces
size_t max_serialized_size_gwpspider_interfaces__msg__DynamixelMotorsData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _DynamixelMotorsData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gwpspider_interfaces__msg__DynamixelMotorsData(
...
static message_type_support_callbacks_t __callbacks_DynamixelMotorsData = {
...
static rosidl_message_type_support_t _DynamixelMotorsData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DynamixelMotorsData,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, msg, DynamixelMotorsData)() {
  return &_DynamixelMotorsData__type_support;
}
