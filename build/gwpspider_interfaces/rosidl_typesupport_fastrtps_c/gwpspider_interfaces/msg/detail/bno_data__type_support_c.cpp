...
#include "gwpspider_interfaces/msg/detail/bno_data__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float32_multi_array__functions.h"  // gravity_vector, rpy
...
using _BnoData__ros_msg_type = gwpspider_interfaces__msg__BnoData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BnoData__ros_msg_type * ros_message = static_cast<const _BnoData__ros_msg_type *>(untyped_ros_message);
  // Field name: rpy
  {
  ...
  // Field name: gravity_vector
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->gravity_vector, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _BnoData__ros_msg_type * ros_message = static_cast<_BnoData__ros_msg_type *>(untyped_ros_message);
  // Field name: rpy
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_gwpspider_interfaces__msg__BnoData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BnoData__ros_msg_type * ros_message = static_cast<const _BnoData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BnoData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gwpspider_interfaces__msg__BnoData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gwpspider_interfaces
size_t max_serialized_size_gwpspider_interfaces__msg__BnoData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BnoData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gwpspider_interfaces__msg__BnoData(
...
static message_type_support_callbacks_t __callbacks_BnoData = {
...
static rosidl_message_type_support_t _BnoData__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, msg, BnoData)() {
  return &_BnoData__type_support;
}
