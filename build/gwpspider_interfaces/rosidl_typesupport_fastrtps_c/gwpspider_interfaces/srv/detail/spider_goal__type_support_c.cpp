...
#include "gwpspider_interfaces/srv/detail/spider_goal__rosidl_typesupport_fastrtps_c.h"
...
using _SpiderGoal_Request__ros_msg_type = gwpspider_interfaces__srv__SpiderGoal_Request;
...
size_t get_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Request(
  const void * untyped_ros_message,
...
static uint32_t _SpiderGoal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gwpspider_interfaces
size_t max_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SpiderGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, srv, SpiderGoal_Request)() {
...
using _SpiderGoal_Response__ros_msg_type = gwpspider_interfaces__srv__SpiderGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gwpspider_interfaces
size_t get_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpiderGoal_Response__ros_msg_type * ros_message = static_cast<const _SpiderGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gwpspider_interfaces
size_t max_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SpiderGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gwpspider_interfaces__srv__SpiderGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, srv, SpiderGoal_Response)() {
...
// already included above
// #include "gwpspider_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "gwpspider_interfaces/srv/spider_goal.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, srv, SpiderGoal)() {
