...
bool gwpspider_interfaces__srv__spider_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * gwpspider_interfaces__srv__spider_goal__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gwpspider_interfaces.srv._spider_goal");
...
ROSIDL_GENERATOR_C_EXPORT
bool gwpspider_interfaces__srv__spider_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
