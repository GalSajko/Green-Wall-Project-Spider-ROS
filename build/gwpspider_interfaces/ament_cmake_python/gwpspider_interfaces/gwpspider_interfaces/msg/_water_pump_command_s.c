...
bool gwpspider_interfaces__msg__water_pump_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gwpspider_interfaces.msg._water_pump_command.WaterPumpCommand", full_classname_dest, 61) == 0);
  }
  gwpspider_interfaces__msg__WaterPumpCommand * ros_message = _ros_message;
  {  // pump
...
{
  /* NOTE(esteve): Call constructor of WaterPumpCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gwpspider_interfaces.msg._water_pump_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WaterPumpCommand");
