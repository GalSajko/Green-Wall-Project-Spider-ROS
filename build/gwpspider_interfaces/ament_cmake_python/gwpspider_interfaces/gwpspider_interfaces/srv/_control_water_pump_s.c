...
{
  /* NOTE(esteve): Call constructor of ControlWaterPump_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gwpspider_interfaces.srv._control_water_pump");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ControlWaterPump_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gwpspider_interfaces__srv__control_water_pump__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gwpspider_interfaces.srv._control_water_pump.ControlWaterPump_Response", full_classname_dest, 70) == 0);
  }
  gwpspider_interfaces__srv__ControlWaterPump_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of ControlWaterPump_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gwpspider_interfaces.srv._control_water_pump");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ControlWaterPump_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
