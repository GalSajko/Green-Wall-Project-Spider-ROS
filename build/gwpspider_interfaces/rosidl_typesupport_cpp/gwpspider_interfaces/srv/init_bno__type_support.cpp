...
static const _InitBno_Request_type_support_symbol_names_t _InitBno_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, srv, InitBno_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gwpspider_interfaces, srv, InitBno_Request)),
  }
};
...
{
  return &::gwpspider_interfaces::srv::rosidl_typesupport_cpp::InitBno_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gwpspider_interfaces, srv, InitBno_Request)() {
  return get_message_type_support_handle<gwpspider_interfaces::srv::InitBno_Request>();
}
...
static const _InitBno_Response_type_support_symbol_names_t _InitBno_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, srv, InitBno_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gwpspider_interfaces, srv, InitBno_Response)),
  }
};
...
{
  return &::gwpspider_interfaces::srv::rosidl_typesupport_cpp::InitBno_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gwpspider_interfaces, srv, InitBno_Response)() {
  return get_message_type_support_handle<gwpspider_interfaces::srv::InitBno_Response>();
}
...
static const _InitBno_type_support_symbol_names_t _InitBno_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, srv, InitBno)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gwpspider_interfaces, srv, InitBno)),
  }
};
...
{
  return &::gwpspider_interfaces::srv::rosidl_typesupport_cpp::InitBno_service_type_support_handle;
}
