...
static const _WalkingInstructions_type_support_symbol_names_t _WalkingInstructions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, msg, WalkingInstructions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gwpspider_interfaces, msg, WalkingInstructions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gwpspider_interfaces, msg, WalkingInstructions)() {
  return &::gwpspider_interfaces::msg::rosidl_typesupport_c::WalkingInstructions_message_type_support_handle;
}
