...
static const _SpiderGoal_Request_type_support_symbol_names_t _SpiderGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, srv, SpiderGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gwpspider_interfaces, srv, SpiderGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gwpspider_interfaces, srv, SpiderGoal_Request)() {
  return &::gwpspider_interfaces::srv::rosidl_typesupport_c::SpiderGoal_Request_message_type_support_handle;
}
...
static const _SpiderGoal_Response_type_support_symbol_names_t _SpiderGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, srv, SpiderGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gwpspider_interfaces, srv, SpiderGoal_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gwpspider_interfaces, srv, SpiderGoal_Response)() {
  return &::gwpspider_interfaces::srv::rosidl_typesupport_c::SpiderGoal_Response_message_type_support_handle;
}
...
static const _SpiderGoal_type_support_symbol_names_t _SpiderGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gwpspider_interfaces, srv, SpiderGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gwpspider_interfaces, srv, SpiderGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gwpspider_interfaces, srv, SpiderGoal)() {
  return &::gwpspider_interfaces::srv::rosidl_typesupport_c::SpiderGoal_service_type_support_handle;
}
