...
#ifndef GWPSPIDER_INTERFACES__SRV__DETAIL__GET_SPIDER_POSE__FUNCTIONS_H_
#define GWPSPIDER_INTERFACES__SRV__DETAIL__GET_SPIDER_POSE__FUNCTIONS_H_
...
/// Initialize srv/GetSpiderPose message.
/**
...
/// Finalize srv/GetSpiderPose message.
/**
...
/// Create srv/GetSpiderPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gwpspider_interfaces__srv__GetSpiderPose_Request__init().
...
/// Destroy srv/GetSpiderPose message.
/**
 * It calls
 * gwpspider_interfaces__srv__GetSpiderPose_Request__fini()
...
/// Check for srv/GetSpiderPose message equality.
/**
...
/// Copy a srv/GetSpiderPose message.
/**
...
/// Initialize array of srv/GetSpiderPose messages.
/**
...
/// Finalize array of srv/GetSpiderPose messages.
/**
 * It calls
 * gwpspider_interfaces__srv__GetSpiderPose_Request__fini()
...
/// Create array of srv/GetSpiderPose messages.
/**
 * It allocates the memory for the array and calls
 * gwpspider_interfaces__srv__GetSpiderPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetSpiderPose messages.
/**
 * It calls
 * gwpspider_interfaces__srv__GetSpiderPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetSpiderPose message array equality.
/**
...
/// Copy an array of srv/GetSpiderPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gwpspider_interfaces__srv__GetSpiderPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gwpspider_interfaces
...
/**
 * It calls
 * gwpspider_interfaces__srv__GetSpiderPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gwpspider_interfaces
...
/**
 * It allocates the memory for the array and calls
 * gwpspider_interfaces__srv__GetSpiderPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gwpspider_interfaces
...
/**
 * It calls
 * gwpspider_interfaces__srv__GetSpiderPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GWPSPIDER_INTERFACES__SRV__DETAIL__GET_SPIDER_POSE__FUNCTIONS_H_
