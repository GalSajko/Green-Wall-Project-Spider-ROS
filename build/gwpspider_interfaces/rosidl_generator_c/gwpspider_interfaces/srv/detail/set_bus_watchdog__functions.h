...
#ifndef GWPSPIDER_INTERFACES__SRV__DETAIL__SET_BUS_WATCHDOG__FUNCTIONS_H_
#define GWPSPIDER_INTERFACES__SRV__DETAIL__SET_BUS_WATCHDOG__FUNCTIONS_H_
...
/// Initialize srv/SetBusWatchdog message.
/**
...
/// Finalize srv/SetBusWatchdog message.
/**
...
/// Create srv/SetBusWatchdog message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Request__init().
...
/// Destroy srv/SetBusWatchdog message.
/**
 * It calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Request__fini()
...
/// Check for srv/SetBusWatchdog message equality.
/**
...
/// Copy a srv/SetBusWatchdog message.
/**
...
/// Initialize array of srv/SetBusWatchdog messages.
/**
...
/// Finalize array of srv/SetBusWatchdog messages.
/**
 * It calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Request__fini()
...
/// Create array of srv/SetBusWatchdog messages.
/**
 * It allocates the memory for the array and calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetBusWatchdog messages.
/**
 * It calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetBusWatchdog message array equality.
/**
...
/// Copy an array of srv/SetBusWatchdog messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gwpspider_interfaces
...
/**
 * It calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gwpspider_interfaces
...
/**
 * It allocates the memory for the array and calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gwpspider_interfaces
...
/**
 * It calls
 * gwpspider_interfaces__srv__SetBusWatchdog_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GWPSPIDER_INTERFACES__SRV__DETAIL__SET_BUS_WATCHDOG__FUNCTIONS_H_
