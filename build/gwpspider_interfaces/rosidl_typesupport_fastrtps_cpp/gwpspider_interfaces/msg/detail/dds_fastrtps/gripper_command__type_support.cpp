...
#include "gwpspider_interfaces/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gwpspider_interfaces::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  return &gwpspider_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, msg, GripperCommand)() {
  return &gwpspider_interfaces::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
