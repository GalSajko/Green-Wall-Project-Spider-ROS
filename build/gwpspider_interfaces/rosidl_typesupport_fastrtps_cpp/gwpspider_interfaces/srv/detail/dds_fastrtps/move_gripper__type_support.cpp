...
#include "gwpspider_interfaces/srv/detail/move_gripper__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const gwpspider_interfaces::msg::GripperCommand &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  gwpspider_interfaces::msg::GripperCommand &);
  ...
  size_t current_alignment)
{
  ...
  // Member: instructions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        gwpspider_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_GripperCommand(
...
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::srv::MoveGripper_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gwpspider_interfaces::srv::MoveGripper_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MoveGripper_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::srv::MoveGripper_Request *>(
...
static size_t _MoveGripper_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MoveGripper_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MoveGripper_Request__callbacks = {
...
static rosidl_message_type_support_t _MoveGripper_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveGripper_Request__callbacks,
...
{
  return &gwpspider_interfaces::srv::typesupport_fastrtps_cpp::_MoveGripper_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::srv::MoveGripper_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<gwpspider_interfaces::srv::MoveGripper_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MoveGripper_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gwpspider_interfaces::srv::MoveGripper_Response *>(
...
static size_t _MoveGripper_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MoveGripper_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MoveGripper_Response__callbacks = {
  "gwpspider_interfaces::srv",
...
static rosidl_message_type_support_t _MoveGripper_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveGripper_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &gwpspider_interfaces::srv::typesupport_fastrtps_cpp::_MoveGripper_Response__handle;
}
...
static service_type_support_callbacks_t _MoveGripper__callbacks = {
  "gwpspider_interfaces::srv",
  "MoveGripper",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, srv, MoveGripper_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gwpspider_interfaces, srv, MoveGripper_Response)(),
...
static rosidl_service_type_support_t _MoveGripper__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveGripper__callbacks,
...
{
  return &gwpspider_interfaces::srv::typesupport_fastrtps_cpp::_MoveGripper__handle;
}
